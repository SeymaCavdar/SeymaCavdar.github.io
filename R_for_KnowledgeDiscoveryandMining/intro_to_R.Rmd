...
The website you see now is a rendered HTML file. to play with the .Rmd file, go to the [original repository](https://github.com/SeymaCavdar/R_for_KnowledgeDiscoveryandMining) and download the .Rmd file and run the codes in RStudio. 
...
(one_to_thirty+1)[(!is.na(one_to_thirty))&one_to_thirty>0]=z
```
